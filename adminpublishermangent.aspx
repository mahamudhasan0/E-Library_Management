<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminpublishermangent.aspx.cs" Inherits="WebApplication3.adminpublishermangent" %>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                             ...
                             <div class="col-md-8">
                                 ...
                                 <div class="form-group">
                                    <asp:TextBox CssClass="form-control" runat="server" placeholder="Publisher Name" ></asp:TextBox>
